...
export function BuildMyTrip() {
  return (
    <section className="bg-paper py-8 tablet:py-10">
      <Container>
        <div className="flex flex-col gap-4 tablet:flex-row tablet:items-stretch tablet:gap-0">
          <div className="flex h-[100px] items-center justify-center rounded-2xl bg-gray-100 px-6 tablet:rounded-r-none desktop:h-[132px] desktop:w-[590px] desktop:shrink-0 desktop:justify-start desktop:pt-[35px] desktop:pr-[82px] desktop:pb-[36px] desktop:pl-[81px]">
