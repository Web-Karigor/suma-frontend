export function AdPlacement() {
  return (
    <div className="mx-auto flex h-[120px] w-full max-w-[1740px] items-center justify-center rounded-[20px] bg-gray-100 px-4 tablet:h-[272px] tablet:rounded-[48px] tablet:px-6">
