      ...
      <Container className="desktop-xl:!px-0">
        <div className="flex flex-col gap-8 desktop:flex-row desktop:items-center desktop:justify-between desktop-xl:h-[230px] desktop-xl:gap-[63px]">
          <div className="flex w-full flex-col gap-5 desktop-xl:w-[966px]">
            ...
            <p className="text-[16px] leading-[1.6] font-normal text-gray-200 tablet:text-[18px]">
              {description}
            </p>
          </div>

          <div className="flex w-full flex-col gap-7 rounded-[32px] bg-overlay-white-08 p-5 desktop-xl:h-[240px] desktop-xl:w-[711px]">
            <h3 className="text-[22px] font-semibold leading-[1.5] text-white">
              Package Details
            </h3>
              ...
              {cards.slice(0, 3).map((card) => (
                ...
                >
                  ...
                  <div className="flex w-full flex-col items-center gap-1.5">
                    <p className="text-center text-[14px] leading-[1.5] font-medium text-teal-300">
                      {card.label}
                    </p>
                    <p className="text-center text-base leading-[1.59] font-medium text-teal-50">
                      {card.value}
                    </p>
                  </div>
                </div>
