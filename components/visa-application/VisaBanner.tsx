    ...
    <section className="bg-[#E8F7F8] py-3 tablet:py-5">
      <Container className="max-w-[1450px]">
        <div className="relative flex min-h-[94px] items-center justify-between gap-5 overflow-hidden px-6 py-4 tablet:px-10">
          <Image src="/images/build-my-trip-sky.png" alt="" fill className="object-cover" sizes="(min-width: 1280px) 1450px, 100vw" />
          ...
          <a href="tel:16703" className="relative z-10 inline-flex h-10 shrink-0 items-center rounded-md bg-black px-5 text-[10px] text-white transition-colors hover:bg-neutral-800">Contact Us Now</a>
        </div>
      </Container>
    </section>
  );
