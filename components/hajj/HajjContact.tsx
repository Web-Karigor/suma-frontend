...
export function HajjContact({ alignWide = false }: HajjContactProps) {
  return (
    <section
      id={alignWide ? "booking" : undefined}
      className={cn("pb-16 tablet:pb-20", alignWide ? "scroll-mt-28 bg-gold-50" : "bg-[#FEFBF5]")}
    >
      <Container className={alignWide ? "desktop-xl:!px-0" : undefined}>
        ...
        <div
          className={cn(
            "mt-8 grid grid-cols-1 gap-4 tablet:grid-cols-3 tablet:gap-5 desktop:mt-[60px] desktop:gap-12",
            !alignWide && "desktop:mx-auto desktop:max-w-[1536px]",
          )}
        >
